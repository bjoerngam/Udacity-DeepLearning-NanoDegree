...
class DDPG():
    ...
    def step(self, action, reward, next_state, done):
        ...
        self.count += 1
        self.memory.add(self.last_state, action, reward, self.total_reward, next_state, done)
...
class ReplayBuffer(object):
    ...
    def add(self, state, action, reward, total_reward, next_state, done):
        """Add a new experience to memory."""
        e = self.experience(state, action, reward, total_reward, next_state, done)
